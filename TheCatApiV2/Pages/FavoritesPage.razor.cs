...
namespace TheCatApiV2.Pages
{
    public partial class FavoritesPage
    {
        ...
        [Inject] Microsoft.AspNetCore.Identity.UserManager<IdentityUser> userManager { get; set; }
        ...
        {
            foreach (var pictureJoined in this.picturesJoined)
            {
        ...
        private void DeleteFavorite(MouseEventArgs e, PictureDatabaseModel parametre)
        {
            ...
            picturesJoined.Remove(picturesJoined.FirstOrDefault(p => p.Picture.Id == parametre.Id));
            picturesJoinedWithoutBreed.Remove(picturesJoinedWithoutBreed.FirstOrDefault(p => p.Picture.Id == parametre.Id));
            pictures.Remove(pictures.FirstOrDefault(p => p.Id == parametre.Id));
            this.StateHasChanged();
        }
